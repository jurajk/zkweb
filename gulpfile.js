...
var paths = {
  ...
  copyScripts: ["node_modules/jquery/dist/jquery.min.js"],
  ...
  scssPaths: ["assets/scss/**/*.scss", "node_modules/foundation-sites/scss"],
...
gulp.task(
  "copyAssets",
  gulp.series(function (done) {
    gulp.src(paths.images).pipe(gulp.dest(paths.dest + "images/"));
    gulp.src(paths.files).pipe(gulp.dest(paths.dest + "files/"));
    gulp.src(paths.favicon).pipe(gulp.dest(paths.dest));
    gulp.src(paths.htaccess).pipe(gulp.dest(paths.dest));
    done();
  })
);
...
gulp.task(
  "copyScripts",
  gulp.series(function (done) {
    gulp.src(paths.copyScripts).pipe(gulp.dest(paths.dest + "/js"));
    done();
  })
);
...
gulp.task(
  "build",
  gulp.series("clean", "copyScripts", "copyAssets", "sass", "twig", "concat")
);
